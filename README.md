...
基于 macrochen/ppt-master 工作流，将 PDF、URL 或 Markdown 材料转成可编辑 PowerPoint 项目与 PPTX。适用于初始化项目、导入源材料、运行 SVG 后处理与导出、以及按 Strategist/Executor 流程生成演示文稿。
...
```bash
gemini skills install ./ppt-master-skill
```
